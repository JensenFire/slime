...
class SGLangEngine(RayActor):
    def __init__(self, args, rank: int, worker_type: str = "regular"):
        self.args = args
        self.rank = rank # i-th engine (may be part of one complete rollout server)
...
def _compute_server_args(args, rank, dist_init_addr, nccl_port, host, port, worker_type: str = "regular", node_hosts: str | None = None):
